...
public class KeySaver {
    ...
    private static final String KEY = "poc";
    private static final String PREFIX = "poc_";
    ...
    public static void saveShare(Activity a, String keyname, boolean f) {
        SharedPreferences settings = a.getSharedPreferences(KEY, Context.MODE_PRIVATE);
    ...
    public static int getIntMinSavedShare(Activity a, String keyname) {
        SharedPreferences settings = a.getSharedPreferences(KEY, Context.MODE_PRIVATE);
    ...
    public static SharedPreferences getShared(Activity a) {
        return a.getSharedPreferences(KEY, Context.MODE_PRIVATE);
    }
